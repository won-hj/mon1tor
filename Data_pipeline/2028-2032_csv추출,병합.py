...
predicted_data = load_original_data('../tool/birth&death_data/-2027data.csv')
...
first_data = pd.read_csv('../tool/birth&death_data/-2027data.csv')
new_data = pd.read_csv('../tool/birth&death_data/tempdata.csv')

combine_data('../tool/birth&death_data/-2027data.csv', '../tool/birth&death_data/tempdata.csv', '../tool/birth&death_data/-2032data.csv')
