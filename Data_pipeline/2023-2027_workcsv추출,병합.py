...
predicted_data = load_original_data('../tool/work&nonwork_data/-2022_data.csv')
...
first_data = pd.read_csv('../tool/work&nonwork_data/-2022_data.csv')
new_data = pd.read_csv('../tool/work&nonwork_data/tempdata.csv')

combine_data('../tool/work&nonwork_data/-2022_data.csv', '../tool/work&nonwork_data/tempdata.csv', '../tool/work&nonwork_data/-2027_data.csv')
