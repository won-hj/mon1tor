...
first_data = pd.read_csv('../tool/work&nonwork_data/-2027_data.csv')
new_data = pd.read_csv('../tool/work&nonwork_data/tempdata.csv')

combine_data('../tool/work&nonwork_data/-2027_data.csv', '../tool/work&nonwork_data/tempdata.csv', '../tool/work&nonwork_data/-2032_data.csv')
