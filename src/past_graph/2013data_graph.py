...
class data:
    def __init__(self, config):
        self.config = config
        pass
        sys.stderr.write('__init__: '+os.getcwd()+ self.config +'2013.csv')
    '''
    [Errno 2] No such file or directory: 
    'C:\\Users\\Administrator\\Desktop\\monitor\\mon2tor\\srcconfig/birth_death/under20222013.csv'
    '''
    def data2013(self):
        #with open(os.getcwd()+ self.config +'2013.csv', encoding='utf-8') as f:        # csv모듈의 reader함수를 이용해 csv파일을 읽어들여 각 행을 구분
        #with open( './../config/bitrh_death/inder2022/'  +'2013.csv', encoding='utf-8') as f:
        with open( self.config  +'2013.csv', encoding='utf-8') as f:
            reader = csv.reader(f)
            birth_death_data = []
            age_data = []
            for row in reader:
...
if __name__ == "__main__":
    ...
    d = data('./../../config/birth_death/under2022/')
    d.data2013()
    print('__name__: '+os.getcwd()+ d.config)
    #print(d.get_plot())
    pass